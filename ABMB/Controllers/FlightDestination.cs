...
public class FlightDestination: ControllerBase
{
  ...
  public async Task<IActionResult> GetPRiceGraph()
  {
    ...
    var request = new HttpRequestMessage()
    {
      ...
      RequestUri = new Uri("https://google-flights2.p.rapidapi.com/api/v1/searchFlights?departure_id=LAX&arrival_id=JFK&travel_class=ECONOMY&adults=1&show_hidden=1&currency=USD&language_code=en-US&country_code=US"),
      Headers =
      {
